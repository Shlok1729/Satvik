...
export default function Navbar() {
  ...
  return (
    <header
      className={`sticky top-0 z-50 transition-all duration-300 ${scrolled || isOpen
    ...
    >
      ...
      {/* Backdrop */}
      <div
        className={`fixed inset-0 h-[100dvh] w-screen bg-black/20 backdrop-blur-sm z-40 md:hidden transition-opacity duration-300 ${isOpen ? "opacity-100" : "opacity-0 pointer-events-none"
          }`}
      ...
      {/* Drawer panel */}
      <div
        className={`fixed top-0 right-0 h-[100dvh] w-72 bg-white z-50 md:hidden shadow-2xl transition-transform duration-300 ease-out flex flex-col ${isOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
