      ...
      <section className="pt-20 pb-16 md:pt-28 md:pb-24 bg-text-dark relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimateOnScroll>
            ...
            <WhatsAppButton size="lg" message="Hi, I am interested in exploring Corporate Yoga for my company. Can we schedule a quick chat?" className="bg-accent text-text-dark hover:bg-white hover:text-accent border-none mx-auto shadow-lg shadow-accent/20">
            ...
            <AnimateOnScroll>
              <div className="relative">
                ...
                <div className="aspect-square md:aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl relative z-10 border-4 border-white">
                  <img
                    src="https://res.cloudinary.com/dhqqj1ehx/image/upload/v1784050291/4415ad40-a4f7-4252-8d40-5a0b3e4dd180.png"
          ...
          <AnimateOnScroll>
            <div className="text-center mb-12">
              <h2 className="font-heading text-3xl md:text-5xl font-bold text-text-dark mb-4">
                Corporate <span className="text-primary">Sessions in Action</span>
              </h2>
            </div>
          </AnimateOnScroll>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <AnimateOnScroll key={idx} delay={idx * 0.1}>
                <div className="aspect-square md:aspect-[4/5] rounded-3xl overflow-hidden shadow-md group border-2 border-white/50">
                  <img
                    src={imgUrl}
                    alt="Corporate Yoga Session"
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <AnimateOnScroll>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <WhatsAppButton size="lg" message="Hi, I'd like to arrange a trial Corporate Yoga session for my team." className="bg-accent hover:text-accent text-text-dark hover:bg-white border-none">
